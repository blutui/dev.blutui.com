...
[`Read more about how canopy works here`](/docs/canvas/functions/canopy/cms-text)
...
<Card title="How do I create a page in the dashboard?" href="/guides/create-page-in-dashboard">
  ...
  <Card title="Canopy element reference" href="/docs/canvas/functions/canopy/cms-text">
