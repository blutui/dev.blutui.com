...
description: Learn how to set up a blog, create posts, and render both the blog index and individual posts using Canvas templates.
---
...
https://dev.blutui.com/guides/create-layout
...
Blutui blogs automatically generate:

* `/your-blog-slug`
* `/your-blog-slug/post-slug`
