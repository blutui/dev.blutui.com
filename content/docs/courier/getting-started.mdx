...
`courier` is easy to install and works on macOS and Windows.
...
<Cards>
  ...
  <Card title="AI agent" href="/docs/courier/installation/ai-agent">
    Let your AI coding agent do the setup.
  </Card>
</Cards>
