...
When using a timezone in the API, you can use one of the values below as the value of the body parameter. For example in the [Project API](/api-reference/console/projects/create), you can use `Pacific/Midway` as the value for `timezone`.
