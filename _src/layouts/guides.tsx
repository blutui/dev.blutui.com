    ...
    <main>
      <header id="header" className="border-b py-8 dark:border-zinc-800">
        <div className="max-w-8xl mx-auto px-8">
          ...
          <h1 className="text-3xl font-bold tracking-tight text-zinc-900 lg:text-4xl dark:text-zinc-200">{title}</h1>
          {guide && (
            <div className="mt-6 flex items-center gap-4 text-zinc-500 dark:text-zinc-400">
              <span className="text-sm font-medium">{guide.authors.join(', ')}</span>
              <span>—</span>
