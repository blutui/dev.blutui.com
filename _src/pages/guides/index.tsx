...
const GuideItem = ({
  ...
  return (
    <Link className="block" href={`/guides/${item.slug}`}>
      <div className="flex w-full flex-col rounded-xl border p-6 transition hover:bg-zinc-100 dark:border-zinc-700 dark:hover:bg-zinc-800">
    ...
    <div className="w-full">
      <div className="mx-auto w-full max-w-8xl px-8">
        ...
        <div className="flex max-w-full gap-8">
          <aside className="sticky top-header -mt-6 hidden max-h-sidebar w-full max-w-64 shrink-0 lg:block">
