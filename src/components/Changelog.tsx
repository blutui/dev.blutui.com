  ...
  return (
    <section id={id} className="md:flex" aria-labelledby={`${id}-heading`}>
      <div className="not-prose pl-7 md:w-1/4 md:pl-0 md:pr-12 md:text-right">
        <h2
          id={`${id}-heading`}
          className="sticky top-24 text-sm leading-6 text-zinc-500"
        >
      ...
      <div className="relative pt-2 pl-7 pb-16 md:w-3/4 md:pt-0 md:pl-12">
        ...
        <div className="absolute -left-1 h-[0.5625rem] w-[0.5625rem] rounded-full border-2 border-zinc-300 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900 md:top-[0.4375rem]"></div>
